...
```bash
git clone https://github.com/Abelsoftware1233/Abel123-AI-.git
cd Abel123-AI-
```
...
⚠️ **Belangrijk:** `.env` staat in `.gitignore` en mag nooit gecommit worden. Vul de keys alleen lokaal in.
